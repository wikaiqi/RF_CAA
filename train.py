...
if __name__=='__main__':
    ...
    parser.add_argument("--game", type=bool, default=False, help="if game_on = ture, run the three-way game; otherwise, run a CNN model")
    parser.add_argument("-l", "--game_lambda", type=float, default=1.3, help="the 3-way game parameter lambda")
    parser.add_argument("--train", type=bool, default=False, help="if true, train model; otherwise, run prediction use checkpoint")
    parser.add_argument("--recalculate", type=bool, default=False, help="if true, regenerate spectrogram data")
    parser.add_argument("--checkpoint", type=str, default='check_point-CNN', help="the path of checkpoint")
